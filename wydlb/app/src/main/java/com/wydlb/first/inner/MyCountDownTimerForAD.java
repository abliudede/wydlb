...
public class MyCountDownTimerForAD extends CountDownTimer {
    ...
    public MyCountDownTimerForAD(long millisInFuture, long countDownInterval, Context context, TextView textview, String hint) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setText(String.format(mContext.getResources().getString(R.string.ad_time),String.valueOf(millisUntilFinished/1000) ));
