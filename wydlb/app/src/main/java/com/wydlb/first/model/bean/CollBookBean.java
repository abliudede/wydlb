...
public class CollBookBean implements Parcelable{
    ...
    @Generated(hash = 1819811414)
    public CollBookBean(String _id, String title, String author, String shortIntro, String cover, String genre, String shareUrl, boolean hasCp,
            String bookUrl, int source, String sourceName, int latelyFollower, double retentionRatio, String updated, String lastRead,
            int chaptersCount, String lastChapter, boolean isUpdate, boolean isLocal, String originNovelId) {
        this._id = _id;
        this.title = title;
        this.author = author;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.originNovelId);
    ...
    protected CollBookBean(Parcel in) {
        ...
        this.originNovelId=in.readString();
