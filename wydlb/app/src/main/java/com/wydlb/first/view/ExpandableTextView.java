...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        if (mCollapsed){
            mButton.setText(mButton.getText().equals("收起")?"更多":"更多");
        }else{
            mButton.setText(mButton.getText().equals("更多")?"收起":"收起");
        }
    ...
    public void setText(@Nullable CharSequence text) {
        mRelayout = true;
        mTv.setText(Html.fromHtml(RxTool.filterChar(text.toString())));
        setVisibility(TextUtils.isEmpty(text) ? View.GONE : View.VISIBLE);
    }

//    public void setNormalText(String text) {//普通文本显示
//        mRelayout = true;
//        mTv.setText(text.replace("<br/>","\n").replace("<br />","\n").replace("<p>","\n").replace("</p>","\n"));
//        setVisibility(TextUtils.isEmpty(text) ? View.GONE : View.VISIBLE);
//    }
...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        ...
        setText(Html.fromHtml(RxTool.filterChar(text.toString())));
...
//            mExpandDrawable = getDrawable(getContext(), R.mipmap.icon_look_all);
//        }
//        if (mCollapseDrawable == null) {
//            mCollapseDrawable = getDrawable(getContext(), R.mipmap.icon_look_all);
//        }
