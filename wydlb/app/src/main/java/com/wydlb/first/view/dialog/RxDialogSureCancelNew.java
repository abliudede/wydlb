...
public class RxDialogSureCancelNew extends RxDialog {
    ...
    public RxDialogSureCancelNew(Context context, int themeResId) {
        super(context, themeResId);
        initView();
    }

    public RxDialogSureCancelNew(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public RxDialogSureCancelNew(Activity context) {
        super(context,R.style.OptionDialogStyle);
        initView();
    }

    public RxDialogSureCancelNew(Context context, float alpha, int gravity) {
