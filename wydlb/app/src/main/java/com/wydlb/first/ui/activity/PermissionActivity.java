...
import com.wydlb.first.base.EasyPermissions;
...
//        StatusBarCompat.translucentStatusBar(this);
    ...
    protected void onResume() {
        super.onResume();
//        if (ReadSettingManager.getInstance().isNightMode()){//夜间模式
//        }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        RxLogTool.e("PermissionActivity onNewIntent");
    }
