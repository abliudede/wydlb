...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight(){
        Resources resources = BuglyApplicationLike.getContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = BuglyApplicationLike.getContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics(){
        DisplayMetrics metrics = BuglyApplicationLike
                .getContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
