 ...
 * 钱包交易记录
 */
public class GoldDrillAdapter extends BaseQuickAdapter<com.wydlb.first.bean.UserDailyTicketStreamBean.DataBean.ListBean,BaseViewHolder> {


    Drawable inComeDrawable;
    Drawable outComeDrawable;
    Context context;
    public GoldDrillAdapter(@Nullable List<com.wydlb.first.bean.UserDailyTicketStreamBean.DataBean.ListBean> data, Context mContext) {
    ...
    @Override
    protected void convert(final BaseViewHolder baseViewHolder,com.wydlb.first.bean.UserDailyTicketStreamBean.DataBean.ListBean bean) {
