...
import com.wydlb.first.bean.HotRankingListBean;
...
public class HotRankGridAdapter extends BaseQuickAdapter<HotRankingListBean.DataBean,BaseViewHolder> {
    ...
    public HotRankGridAdapter(@Nullable List<HotRankingListBean.DataBean> data, Context mContext) {
    ...
    protected void convert(final BaseViewHolder baseViewHolder,HotRankingListBean.DataBean bean) {
        ...
        tv_book_list_name.setVisibility(View.GONE);
