...
public class RxNetTool {
    ...
    public static boolean isAvailable() {
        NetworkInfo info = getActiveNetworkInfo(BuglyApplicationLike.getContext());
        return info != null && info.isAvailable();
    }

    public static boolean showNetworkUnavailable(String message) {
        return message.equals(Constant.NetWorkStatus.NETWORK_UNAVAILABLE)?true:false;
    }
