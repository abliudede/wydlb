...
public class StickerManager {
    ...
    private static final String CATEGORY_LZX = "lzx";
    private static final String CATEGORY_XXY = "xxy";
    private static final String CATEGORY_LZXX = "lzxx";
    ...
    private void initStickerOrder() {
        // 默认贴图顺序
        stickerOrder.put(CATEGORY_LZXX, 1);
        stickerOrder.put(CATEGORY_LZX, 2);
        stickerOrder.put(CATEGORY_XXY, 3);

    }

    private boolean isSystemSticker(String category) {
        return CATEGORY_LZX.equals(category) ||
                CATEGORY_XXY.equals(category)||
                CATEGORY_LZXX.equals(category);
    }
    ...
    public String getStickerUri(String categoryName, String stickerName) {
        ...
        RxLogTool.e("categoryName:"+categoryName+"--stickerName:"+stickerName);
        if (isSystemSticker(categoryName)) {
            if (categoryName.equals(CATEGORY_LZX)){
