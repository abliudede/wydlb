...
public class ChatRoomNotificationHelper {
    public static String getNotificationText(ChatRoomNotificationAttachment attachment) {
        ...
        switch (attachment.getType()) {
            case ChatRoomMemberIn:
                text = buildText("欢迎", targets, "进入聊天室");
                break;
            case ChatRoomMemberExit:
                text = buildText(targets, "离开了聊天室");
                break;
            ...
            case ChatRoomCommonRemove:
                ...
                break;
            case ChatRoomClose:
                text = buildText("聊天室被关闭");
                break;
            case ChatRoomInfoUpdated:
                text = buildText("聊天室信息已更新");
                break;
            case ChatRoomMemberKicked:
                text = buildText(targets, "被踢出聊天室");
                break;
            case ChatRoomMemberTempMuteAdd:
                text = buildText(targets, "因被多人投诉，禁言24小时");
                break;
    ...
    private static String getTargetNicks(final ChatRoomNotificationAttachment attachment) {
        ...
        if (attachment.getTargetNicks() != null && null != NimUIKit.getAccount()) {
