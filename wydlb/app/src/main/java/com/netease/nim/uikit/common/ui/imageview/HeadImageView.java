...
public class HeadImageView extends SelectableRoundedImageView {
    ...
    private static final int DEFAULT_AVATAR_RES_ID = R.mipmap.default_fangxing_logo;

    public HeadImageView(Context context) {
        super(context);
        setBorderColor(Color.WHITE);
        setCornerRadiiDP(5,5,5,5);
    }
    ...
    public void loadTeamIconByTeam(final Team team) {
        doLoadImage(team != null ? team.getIcon() : null, DEFAULT_AVATAR_RES_ID, DEFAULT_AVATAR_THUMB_SIZE);
    }
