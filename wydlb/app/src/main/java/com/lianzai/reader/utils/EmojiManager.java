 ...
 *@description 表情管理
 *@author qicheng.qing
 *@create  17/4/18 17:49
*/
public class EmojiManager {

    private static final String TAG=EmojiManager.class.getName();
    ...
    static {
        Context context = BuglyApplicationLike.getContext();
    ...
    private static Bitmap loadAssetBitmap(Context context, String assetPath) {
        RxLogTool.e("assetPath:"+assetPath);
        InputStream is = null;
        try {
