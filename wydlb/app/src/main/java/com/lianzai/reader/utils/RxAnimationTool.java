...
import com.lianzai.reader.interfaces.OnUpdateListener;

import static com.lianzai.reader.utils.RxImageTool.invisToVis;
import static com.lianzai.reader.utils.RxImageTool.visToInvis;
...
//                textView.setTextColor((Integer) animation.getAnimatedValue());
     ...
     * @param view
     */
    public static void zoomIn(final View view, float scale, float dist,long duration) {
     ...
     * @param view
     */
    public static void zoomOut(final View view, float scale,long duration) {
        view.setPivotY(view.getHeight());
        view.setPivotX(view.getWidth() / 2);
        AnimatorSet mAnimatorSet = new AnimatorSet();
