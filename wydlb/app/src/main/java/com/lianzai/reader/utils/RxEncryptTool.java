...
import static com.lianzai.reader.utils.RxDataTool.bytes2HexString;
import static com.lianzai.reader.utils.RxDataTool.hexString2Bytes;
...
public class RxEncryptTool {
    ...
    public static byte[] DESTemplet(byte[] data, byte[] key, String algorithm, String transformation, boolean isEncrypt) {
        try {
            ...
            e.printStackTrace();
            RxLogTool.e("DESTemplet:"+e.toString());
        }
        return null;
    }
