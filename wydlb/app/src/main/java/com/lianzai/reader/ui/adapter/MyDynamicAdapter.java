 ...
 * 我的动态
 */
public class MyDynamicAdapter extends BaseQuickAdapter<Object, BaseViewHolder> {
    ...
    public MyDynamicAdapter(@Nullable List<Object> data, Context mContext) {
        super(R.layout.item_my_dynamic_content_view, data);
    ...
    protected void convert(final BaseViewHolder holder, Object obj) {
        ...
        //圈子信息
        RelativeLayout circle_view = holder.getView(R.id.circle_view);
        SelectableRoundedImageView iv_flatform_cover = holder.getView(R.id.iv_flatform_cover);
        TextView tv_platform_name = holder.getView(R.id.tv_platform_name);
        //用户信息
...
//            );
        ...
        /*开始数据加载*/
        /*通用部分*/
        RxImageTool.loadLogoImage(mContext, listBean.getPlatformCover(), iv_flatform_cover);
        tv_platform_name.setText(listBean.getPlatformName());
