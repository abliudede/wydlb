...
/**
 * Created by lrz on 2017/10/13.--首页最新书单
 */

public class HomeBookListListAdapter extends BaseQuickAdapter<BookListResponse.DataBean.ListBean,BaseViewHolder> {


    String mKeyword="";

    Context context;
    public HomeBookListListAdapter(@Nullable List<BookListResponse.DataBean.ListBean> data, Context mContext) {
        super(R.layout.item_home_book_list_list, data);
