package com.lianzai.reader.view.tab;
...
import com.lianzai.reader.view.tab.listener.OnTabSelectListener;
import com.lianzai.reader.view.tab.utils.FragmentChangeManager;
import com.lianzai.reader.view.tab.utils.UnreadMsgUtils;
import com.lianzai.reader.view.tab.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTitleVisible = ta.getBoolean(R.styleable.CommonTabLayout_tl_titleVisible, true);
