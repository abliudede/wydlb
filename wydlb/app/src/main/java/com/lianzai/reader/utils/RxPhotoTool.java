...
import static com.lianzai.reader.utils.RxFileTool.getDataColumn;
import static com.lianzai.reader.utils.RxFileTool.isDownloadsDocument;
import static com.lianzai.reader.utils.RxFileTool.isExternalStorageDocument;
import static com.lianzai.reader.utils.RxFileTool.isGooglePhotosUri;
import static com.lianzai.reader.utils.RxFileTool.isMediaDocument;
...
public class RxPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        RxLogTool.e("生成的照片输出路径：" + imageFilePath[0].toString());
...
//            Cursor cursor = context.getContentResolver().query(uri, new String[]{MediaStore.Images.ImageColumns.DATA}, null, null, null);
    ...
    public static Bitmap getBitmap(String path, int size) {
        try {
            ...
            Bitmap temp = BitmapFactory
                    .decodeStream(new FileInputStream(path), null, opt);

            Bitmap bitmap = imageZoom(temp, size);//图片压缩
            return bitmap;
    ...
    public static InputStream bitmap2InputStreamPNG(Bitmap bm) {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
