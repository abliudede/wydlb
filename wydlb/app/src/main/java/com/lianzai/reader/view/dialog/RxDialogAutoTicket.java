...
public class RxDialogAutoTicket extends Dialog {
    ...
    public RxDialogAutoTicket(Context context, int themeResId) {
        super(context, themeResId);
        initView();
    }

    public RxDialogAutoTicket(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public RxDialogAutoTicket(Activity context) {
        super(context);
        initView();
    }
    ...
    private void initView() {
        ...
        View dialogView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_auto_ticket, null);
