...
public class MyCountDownTimerForGame extends CountDownTimer {
    ...
    public MyCountDownTimerForGame(long millisInFuture, long countDownInterval, Context context, TextView textview, String hint) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setText(String.format(mContext.getResources().getString(R.string.game_time),String.valueOf(millisUntilFinished / 1000) ));
