package com.lianzai.reader.mixpush;
...
public class DemoMixPushMessageHandler implements MixPushMessageHandler {
    ...
    public boolean onNotificationClicked(Context context, Map<String, String> payload) {
        ...
        RxLogTool.e("rev pushMessage payload " + payload);
...
//            RxToast.custom("本次推送有数据，可以跳转到对应页面", Constant.ToastType.TOAST_SUCCESS).show();
...
//            RxToast.custom("本次推送没有数据，不能跳转到对应页面", Constant.ToastType.TOAST_ERROR).show();
            return false;
        }
    }
