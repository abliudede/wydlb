...
public class ChatRoomEditNotice extends BaseActivity {
    ...
    public static void startActivity(Context context,String chatRoomId, String nickName, String head, Long time, String notice,int role){
        ...
        RxActivityTool.skipActivity(context,ChatRoomEditNotice.class,bundle);
    }
    ...
    private void requestChatRoomNotice(String notice){
        ...
        hashMap.put("announcement",notice);
        hashMap.put("roomId",roomId);
        OKHttpUtil.okHttpPut(Constant.API_BASE_URL + "/chatrooms/announcement/"+roomId,hashMap, new CallBackUtil.CallBackString() {
            @Override
