...
public class RxDialogBitmapShare extends Dialog {
    ...
    public RxDialogBitmapShare(Context context, int themeResId) {
        super(context, themeResId);
        initView();
    }

    public RxDialogBitmapShare(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        initView();
    }

    public RxDialogBitmapShare(Context context) {
        super(context);
        initView();
    }

    public RxDialogBitmapShare(Activity context) {
        super(context);
        initView();
    }
    ...
    private void initView() {
        ...
        View dialogView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_bitmap_share, null);
