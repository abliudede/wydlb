...
public interface SendSmsContract {
    ...
    interface View extends BaseContract.BaseView {
        void getSmsCodeSuccess(SendSmsResponse sendSmsResponse);
    ...
    interface Presenter<T> extends BaseContract.BasePresenter<T> {
        ...
        void getSmsCode(ArrayMap<String,Object> params);
        void sendBindThirdCode(ArrayMap<String,Object> params);
    }
