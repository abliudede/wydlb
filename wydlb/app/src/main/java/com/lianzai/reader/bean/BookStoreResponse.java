...
public class BookStoreResponse extends  BaseBean{
    ...
    public static class DataBean {
        ...
        public void setRecognitionList(List<BookStoreBeanN> recognitionList) {
            this.recognitionList = recognitionList;
        }

        public List<BookStoreBeanN> getRecognitionDeleteList() {
            return recognitionDeleteList;
        }

        public void setRecognitionDeleteList(List<BookStoreBeanN> recognitionDeleteList) {
            this.recognitionDeleteList = recognitionDeleteList;
        }
        ...
        public void setDelete_List(List<BookStoreBeanN> delete_List) {
